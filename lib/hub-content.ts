...
export const DEFAULT_POSTS: Omit<HubPost, "updatedAt">[] = [
  ...
  { id: "shard-cards", slug: "shard-cards", type: "shard", title: "Фрагмент карты без хаоса", summary: "Что выбирать и как строить комбинации всей командой.", content: "Как быстро оценить предложенные правила раунда и выбрать фрагмент карту, которая усиливает план команды. Дополняй материал своими комбинациями.", readTime: "7 мин", accent: "cyan", published: true, sortOrder: 30 },
