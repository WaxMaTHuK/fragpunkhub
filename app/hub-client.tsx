...
export function HubClient({ initialPosts, storageUnavailable = false }: { initialPosts: HubPost[]; storageUnavailable?: boolean }) {
  ...
  return <div className="site-shell">
    <header className="site-header"><div className="wrap header-row">
      ...
      <nav className="main-nav" aria-label="Основная навигация"><a href="#materials">Материалы</a><a href="#sections">Разделы</a><a className="tier-link" href="/tier-list">Тир-лист</a><a className="admin-link" href="/admin"><ShieldCheck size={17} /> Редактор</a></nav>
    </div></header>
