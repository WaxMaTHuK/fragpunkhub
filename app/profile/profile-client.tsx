...
const avatars = ["⚡", "🎯", "🦊", "👾", "🛡️", "🔥"];
const ranks = [
  { name: "Бронза", icon: "♜", tone: "bronze" },
  { name: "Серебро", icon: "♜", tone: "silver" },
  { name: "Золото", icon: "♛", tone: "gold" },
  { name: "Платина", icon: "♛", tone: "platinum" },
  { name: "Алмаз", icon: "♚", tone: "diamond" },
  { name: "Мастер", icon: "♚", tone: "master" },
  { name: "Ас", icon: "♚", tone: "ace" },
  { name: "Панк-мастер", icon: "♚", tone: "punkmaster" },
] as const;
const frames: Frame[] = [
